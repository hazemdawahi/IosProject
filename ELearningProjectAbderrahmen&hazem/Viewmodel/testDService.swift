...
#endif
class testDService {
    static let shareinstance = testDService()
    ...
    func question()-> String
    {
        ...
        var request = URLRequest(url: URL(string: "http://localhost:3000/api/testD/question")!,timeoutInterval: Double.infinity)
    ...
    func answer(testD : testDModel)
    {

        var semaphore = DispatchSemaphore (value: 0)
        let parameters = "{\n\"useranswer\":\""+testD.answer1+"\"}"
    ...
    func  evaluation()-> String {
        ...
        var request = URLRequest(url: URL(string: "http://localhost:3000/api/testD/evaluation")!,timeoutInterval: Double.infinity)
        request.addValue("JWT=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiaGF6ZW0iLCJpYXQiOjE2Mzg1NDg3MTksImV4cCI6MTYzODU1MjMxOX0.x2gYETOmDxPY7cvcPWRQel2qaIyrnJTCOdABovtz78Q; Role=admin; UserID=61aa44dd36bf528c4d922e97; langue=it", forHTTPHeaderField: "Cookie")
    ...
    func score ()->String{
        ...
        var request = URLRequest(url: URL(string: "http://localhost:3000/api/testD/score")!,timeoutInterval: Double.infinity)
        request.httpMethod = "GET"
    ...
    func pass ()-> String{
        ...
        var request = URLRequest(url: URL(string: "http://localhost:3000/api/testD/pass")!,timeoutInterval: Double.infinity)
        request.httpMethod = "GET"
