//
//  Evaluation8ViewController.swift
...
class Evaluation8ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let questionR = lvl8Service.shareinstance.question()
        let scoreR = lvl8Service.shareinstance.score()
        let pass = lvl8Service.shareinstance.pass()
            ...
            if( pass.contains("yes"))
            {
                ...
                let alertController = UIAlertController(title: "Congratulation", message: "You sucessed", preferredStyle: .alert)
                        ...
                        let OKAction = UIAlertAction(title: "OK", style: .default) { (action:UIAlertAction!) in
                            ...
                            UserService.shareinstance.changepro9()
                            UserService.shareinstance.where9()
                            UserService.shareinstance.changevieminus()
                            self.performSegue(withIdentifier: "exit8", sender: nil)
    ...
    func evel()
    {
        ...
        let lvl8M = lvl8Model(question1: "", answer1: useranswer.text!, question2: "", answer2: "", question3: "", answer3: "", question4: "", answer4: "", question5: "", answer5: "", question6: "", answer6: "", question7: "", answer7: "", question8: "", answer8: "", question9: "", answer9: "", question10: "", answer10: "")
                                
        let message = lvl8Service.shareinstance.answer(Lvl8: lvl8M)
    }
